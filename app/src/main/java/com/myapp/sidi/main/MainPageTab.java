...
//        btn_choice= findViewById(R.id.btn_choice);
        ...
        while (cursor.moveToNext()) {
            ...
            choice_6 = cursor.getString(cursor.getColumnIndexOrThrow(SelectFurnitureContract.TableEntry.COLUMN_CHOICE_6));
        ...
        btn_choiceRevise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                switch (count) {
                    ...
                    case 6:
                        InitSelectPage.REVISE_CODE = 1;
                        Intent intent6 = new Intent(MainPageTab.this, InitSelectPage.class);
                        intent6.putExtra("size", "6");
                        intent6.putExtra("existChoice_1", choiceArr.get(0).toString());
                        intent6.putExtra("existChoice_2", choiceArr.get(1).toString());
                        intent6.putExtra("existChoice_3", choiceArr.get(2).toString());
                        intent6.putExtra("existChoice_4", choiceArr.get(3).toString());
                        intent6.putExtra("existChoice_5", choiceArr.get(4).toString());
                        intent6.putExtra("existChoice_6", choiceArr.get(5).toString());
