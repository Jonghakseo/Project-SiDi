...
public class SimilarImageDetailData {
    @SerializedName("result")
    @Expose
    private List<Result> result = new ArrayList<>();

    public SimilarImageDetailData(String url, String serverIndex, String designNum, String registrationNum, String designCode, String country, String designName, String registerPerson, String dateApplication, String dateRegistration, String datePublication, String dep1, String dep2, String dep3, String dep4, String dep5) {
    }
